...
import { injectVNActionsUI, updateVnGeneratorEnabledState } from './modules/actions.js';
...
window['updateVnGeneratorEnabledState'] = updateVnGeneratorEnabledState;
window['updateGeneratorToolbarButton'] = updateGeneratorToolbarButton;
...
jQuery(async () => {
    try {
        ...
        const getAutoGenProbeStatus = () => {
            ...
            if (isGeneratorDisabled()) return { state: 'abort', reason: 'generator-disabled' };
